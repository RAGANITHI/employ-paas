package com.insignia.employ.Chatapp;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserData = FirebaseDatabase.getInstance().getReference("appusers").child(Objects.requireNonNull(mAuth.getUid())).child("userdetails");
        ...
        mUserData.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                username = Objects.requireNonNull(dataSnapshot.child("firstname").getValue()).toString();
            }
